    ...
    with st.spinner("The Chronicler records your deeds... (Updating long-term memory)"):
        ...
        **Your Concise Summary:**
        ...
        try:
            ...
            st.toast("Long-term memory updated!", icon="📜")
        except Exception as e:
...
def render_game_ui():
    ...
    st.title("🧙 The Generative Bard: Chronicle of the Ages")
...
def main():
    ...
    st.set_page_config(page_title="The Generative Bard", page_icon="🧙", layout="wide")
